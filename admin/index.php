...
$query = $db->prepare('DELETE FROM posts WHERE id = :confirmDelete');
                    ...
                    <?php foreach ($articles as $article) : ?>
                        <tr>
                            ...
                            <td class="py-3">
                                ...
                                <a href="#" title="Delete" class="ps-2 btn btn-outline-danger btnDelete" data-bs-toggle="modal" data-bs-target="#confirmDelete">Delete this article</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Delete the article</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    you sure you want to delete this article ?
                                </div>
